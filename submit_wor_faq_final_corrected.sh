#!/bin/sh
#SBATCH --job-name=wor_corr
#SBATCH -p preempt
#SBATCH --nodes=1
#SBATCH -A marlowe-m000127
#SBATCH -G 1
#SBATCH --time=12:00:00
#SBATCH --output=logs/final/slurm_wor_corr_%A_%a.out
#SBATCH --error=logs/final/slurm_wor_corr_%A_%a.err
#SBATCH --array=0-2
...
python wor_faq_final_corrected.py $SLURM_ARRAY_TASK_ID
