...
summary = pd.read_csv("pew_study/logs/cleaned/summary.csv")
...
def make_figure(ess_col, ess_serr_col, methods, out_path, legend_ncol=3, budget_subset=None):
    ...
    os.makedirs("pew_study/figures", exist_ok=True)
...
make_figure("ess_multiplier_vs_classical", "ess_multiplier_vs_classical_serr",
            method_config_main,
            "pew_study/figures/pew_main.pdf",
            legend_ncol=4)
...
make_figure("ess_multiplier_vs_classical", "ess_multiplier_vs_classical_serr",
            method_config_main,
            "pew_study/figures/pew_main_sparse.pdf",
