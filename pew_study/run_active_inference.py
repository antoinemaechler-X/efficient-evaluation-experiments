"""
Active Inference estimator for Pew ATP Wave 79 dataset.

Usage: python pew_study/run_active_inference.py <seed_chunk>
...
Implementation matches their notebook cell-by-cell:
...
logs_fname = f"pew_study/logs/active_inference_sl={seed_chunk}.csv"
