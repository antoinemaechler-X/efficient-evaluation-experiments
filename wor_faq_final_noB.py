"""
WOR FAQ Final (A-only variance): Run FAQ with best hyperparameters on test models M2.
Uses variance_mode="A_only" (σ̂² = Â, dropping B̂ entirely).

Same as wor_faq_final.py but with conservative variance estimation.
Output: logs/final/wor_faq_final_noB_sl={chunk}.csv

Usage:
    python wor_faq_final_noB.py <seed_chunk>
...
logs_fname = f"wor_faq_final_noB_sl={int(sys.argv[1])}.csv"
