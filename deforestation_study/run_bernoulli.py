"""
Bernoulli-based estimators for Amazon deforestation dataset.

Usage: python deforestation_study/run_bernoulli.py <seed_chunk>
...
logs_fname = f"deforestation_study/logs/bernoulli_sl={seed_chunk}.csv"
