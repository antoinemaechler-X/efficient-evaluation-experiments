"""
WOR-AIPW estimator for Amazon deforestation dataset.

Usage: python deforestation_study/run_wor.py <seed_chunk>
...
logs_fname = f"deforestation_study/logs/wor_sl={seed_chunk}.csv"
