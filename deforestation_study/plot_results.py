...
summary = pd.read_csv("deforestation_study/logs/cleaned/summary.csv")
...
def make_figure(ess_col, ess_serr_col, methods, out_path, legend_ncol=3, budget_subset=None):
    ...
    os.makedirs("deforestation_study/figures", exist_ok=True)
...
# Plot 1: All 7 methods, ESS relative to WOR-uniform
make_figure("ess_multiplier", "ess_multiplier_serr",
            method_config,
            "deforestation_study/figures/deforestation_ess+coverage_vs_wor_uniform.pdf")

# Plot 2: All 7 methods, ESS relative to Classical
make_figure("ess_multiplier_vs_classical", "ess_multiplier_vs_classical_serr",
            method_config,
            "deforestation_study/figures/deforestation_ess+coverage_vs_classical.pdf")
...
make_figure("ess_multiplier_vs_classical", "ess_multiplier_vs_classical_serr",
            method_config_main,
            "deforestation_study/figures/deforestation_main.pdf",
            legend_ncol=3)
...
make_figure("ess_multiplier_vs_classical", "ess_multiplier_vs_classical_serr",
            method_config_main,
            "deforestation_study/figures/deforestation_main_sparse.pdf",
