...
#SBATCH --output=results/slurm_galaxy_%A_%a.out
#SBATCH --error=results/slurm_galaxy_%A_%a.err
#SBATCH --array=0-11
...
cd ~/efficiently-evaluating-llms/clean_experiments/galaxy_study

# 12 jobs: 4 scripts x 3 seed chunks
# 0-2:  run_wor.py
# 3-5:  run_bernoulli.py
# 6-8:  run_cross_ppi.py
# 9-11: run_active_inference.py
