...
#SBATCH --output=logs/final/slurm_wor_bl_%A_%a.out
#SBATCH --error=logs/final/slurm_wor_bl_%A_%a.err
#SBATCH --array=0-5
...
python wor_baselines.py $dataset $seed_chunk
