...
#SBATCH --output=pew_study/logs/slurm_pew_fix_%A_%a.out
#SBATCH --error=pew_study/logs/slurm_pew_fix_%A_%a.err
#SBATCH --array=0-2
...
# NOTE: run_wor.py and run_active_inference.py are NOT re-run (no changes)
