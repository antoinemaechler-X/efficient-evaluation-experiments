"""
WOR-AIPW estimator for Galaxy Zoo 2 dataset.

Usage: python galaxy_study/run_wor.py <seed_chunk>
  seed_chunk ∈ {0, 1, 2}: splits 1000 seeds into 3 chunks.

Runs WOR-active and WOR-uniform on the full population (no groups).
No factor model — uses fixed ppi_py predictions.
...
# --- Output setup ---
os.makedirs("galaxy_study/logs", exist_ok=True)
columns = ["group", "prop_budget", "method", "seed", "width", "coverage"]
logs_fname = f"galaxy_study/logs/wor_sl={seed_chunk}.csv"
