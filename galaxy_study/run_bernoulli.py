"""
Bernoulli-based estimators for Galaxy Zoo 2 dataset.

Usage: python galaxy_study/run_bernoulli.py <seed_chunk>
...
logs_fname = f"galaxy_study/logs/bernoulli_sl={seed_chunk}.csv"
