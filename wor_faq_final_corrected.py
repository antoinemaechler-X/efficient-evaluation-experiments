"""
WOR FAQ Final (bias-corrected variance): Run FAQ with best hyperparameters on test models M2.
Uses variance_mode="corrected" (σ̂² = Â − B̂ + Ĉ, bias-corrected estimator).

Same as wor_faq_final.py but with bias-corrected variance estimation (§4.8).
Output: logs/final/wor_faq_final_corrected_sl={chunk}.csv

Usage:
    python wor_faq_final_corrected.py <seed_chunk>
...
logs_fname = f"wor_faq_final_corrected_sl={int(sys.argv[1])}.csv"
